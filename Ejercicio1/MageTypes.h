...
class Sorcerer: public Mage {
    public:
        Sorcerer(double health, float resistance, vector<unique_ptr<Weapon>> weapons, ELEMENT_T elem);
...
class Conjurer: public Mage {
    public:
        Conjurer(double health, float resistance, vector<unique_ptr<Weapon>> weapons);
...
class Wizard: public Mage {
    public:
        Wizard(double health, float resistance, vector<unique_ptr<Weapon>> weapons);
...
class Necromancer: public Mage {
    public:
        Necromancer(double health, float resistance, vector<unique_ptr<Weapon>> weapons, int souls);
